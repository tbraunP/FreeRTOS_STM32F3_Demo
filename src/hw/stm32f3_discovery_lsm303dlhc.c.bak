...
void LSM303DLHC_AccInit(LSM303DLHCAcc_InitTypeDef *LSM303DLHC_InitStruct) {
	...
	if (LSM303DLHC_InitStruct->FifoMode != LSM303DLHC_FIFO_BYPASS_MODE ) {
		uint8_t fifoEnable = 0x40;
		LSM303DLHC_Write(ACC_I2C_ADDRESS, LSM303DLHC_CTRL_REG5_A, &fifoEnable);
	}
}
...
void LSM303DLHC_AccFilterConfig(
	...
	tmpreg |=
			(uint8_t)(
					LSM303DLHC_FilterStruct->HighPassFilter_Mode_Selection
							|\
...
void LSM303DLHC_MagInit(LSM303DLHCMag_InitTypeDef *LSM303DLHC_InitStruct) {
	...
	cra_regm |= (uint8_t)(
			LSM303DLHC_InitStruct->Temperature_Sensor

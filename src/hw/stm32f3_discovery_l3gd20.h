...
#define L3GD20_FIFO_STREAM	     			((uint8_t)0x40)
#define L3GD20_FIFO_STREAM_TO_FIFO	     	((uint8_t)0x60)
#define L3GD20_FIFO_BYPASS_TO_STREAM     	((uint8_t)0x80)
/**
  * @}
  */
...
#define L3GD20_INT2INTERRUPT_ENABLE_DRDY   ((uint8_t)0x08)
#define L3GD20_INT2INTERRUPT_ENABLE_WTM	   ((uint8_t)0x04)
/**
  * @}
  */
...
void L3GD20_EnableFIFO(uint8_t FifoMode);
...
extern uint32_t L3GD20_TIMEOUT_UserCallback(void);

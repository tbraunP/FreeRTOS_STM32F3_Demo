...
void L3GD20_INT1InterruptConfig(
	...
	ctrl_cfr |= (uint8_t)(
			L3GD20_IntConfigStruct->Latch_Request
...
void L3GD20_FilterConfig(L3GD20_FilterConfigTypeDef *L3GD20_FilterStruct) {
	...
	tmpreg |= (uint8_t)(
			L3GD20_FilterStruct->HighPassFilter_Mode_Selection
					|\
...
static void L3GD20_LowLevel_Init(void) {
	...
	RCC_AHBPeriphClockCmd(
			L3GD20_SPI_SCK_GPIO_CLK | L3GD20_SPI_MISO_GPIO_CLK
					| L3GD20_SPI_MOSI_GPIO_CLK, ENABLE);
